...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="form row">
        <div class="form-group col-md-8">
            ...
            <input type="text" class="form-control" name="titre" id="titre" required="required" placeholder="veuillez mettre le Titre">
        </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="toilette" id="toilette">
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="jardin" id="jardin">
        </div>
        <div class="form-group col-md-4">
    ...
    <div class="forme row">
        ...
        <div class="form-groupe col-md-4">
            ...
            <input class="form-control" name="ville" id="ville" required="required" placeholder="veuillez choisir une ville">
        </div>
        <div class="form-group col-md-4">
